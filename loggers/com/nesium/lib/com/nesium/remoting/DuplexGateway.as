...
package com.nesium.lib.com.nesium.remoting
{
	import com.nesium.lib.com.nesium.logging.zz;
	import com.nesium.lib.com.nesium.remoting.types.AMFActionMessage;
	import com.nesium.lib.com.nesium.remoting.types.AMFMessageBody;
	import com.nesium.lib.com.nesium.remoting.types.AMFMessageHeader;
...
sendActionMessage( am );
			...
			var result : InvocationResult = new InvocationResult( serviceName, methodName, arguments, m_invocationCount++ );
...
// log('processActionMessage');
			for each (var body:AMFMessageBody in am.bodies)
			{
				...
				var result : * = service[methodName].apply( service, (body.data is Array ? body.data : [ body.data ]) );
...
invocationIndex : int, resultType : String) : void
		{
			...
			{
				if (nextResult.invocationIndex == invocationIndex && nextResult.serviceName == serviceName && nextResult.methodName == methodName)
				{
					result = nextResult;
					break;
				}
